                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-withdraw-table-filter="search"
                                class="form-control form-control-solid w-250px ps-12" placeholder="Search Withdrawals" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center">
                                        <a href="#" class="text-gray-800 text-hover-primary mb-1">No withdraw
                                            transactions found</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
